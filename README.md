...
[`glasgow_analysis.ipynb`](https://github.com/rflperry/m_estimation_SI/blob/main/glasgow_analysis.ipynb). Simulation results can be replicated by the following command:
